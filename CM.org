...
- W de t avec D de t+3
- W de t avec E de t+2
- M de t avec D de t+2
- M de t avec E de t+1
...
Deux types :
- Dépendances de données : opérandes en commun
- Dépendances de contrôle : une instruction est à exécuter seulement suivant 
#+END_DEFINITION
...
Pas de bypass entrant en MEM !

Page 20 [refaire le schéma simplifié]

[refaire l'optimisation]

Déroulage de boucle à bas niveau :

Bien réécrire les dépendances.

Réécrire le schéma simplifié.


Problèmes de déroulage :
- Empreinte mémoire dans la section de texte
